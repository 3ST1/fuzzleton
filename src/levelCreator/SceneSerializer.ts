...
export class SceneSerializer {
  ...
  public static serializeScene(
    ...
    meshes.forEach((mesh) => {
      ...
      serializedMeshes.push(serializedMesh);
    });
    ...
    const scene: SerializedScene = {
      ...
      metadata: {
        ...
        version: "0.3", // Increment version since we added physics data
      },
    };
  ...
  public static parseSerializedScene(jsonString: string): SerializedScene {
    try {
      return JSON.parse(jsonString) as SerializedScene;
    } catch (error) {
